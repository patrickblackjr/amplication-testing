...
export class UserControllerBase {
  ...
  async findManyAssignedEvents(
    ...
    const results = await this.service.findAssignedEvents(params.id, {
      ...query,
      select: {
  ...
  @common.Post("/:id/assignedEvents")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async createAssignedEvents(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Patch("/:id/assignedEvents")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async updateAssignedEvents(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/assignedEvents")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async deleteAssignedEvents(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
